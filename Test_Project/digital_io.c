...
const pin RA0  = { &RA, 1,     &RPA0R,  &GROUP1, 0, 1, 0 } ;
const pin RA1  = { &RA, 2,     &RPA1R,  &GROUP2, 1, 1, 0 } ;
const pin RA2  = { &RA, 4,     &RPA2R,  &GROUP3, 0, 0 } ;
const pin RA3  = { &RA, 8,     &RPA3R,  &GROUP4, 0, 0 } ;
const pin RA4  = { &RA, 16,    &RPA4R,  &GROUP3, 0, 0 } ;

const pin RB0  = { &RB, 1,     &RPB0R,  &GROUP4, 2, 1, 0 } ;
const pin RB1  = { &RB, 2,     &RPB1R,  &GROUP2, 3, 1, 0 } ;
const pin RB2  = { &RB, 4,     &RPB2R,  &GROUP3, 4, 1, 0 } ;
const pin RB3  = { &RB, 8,     &RPB3R,  &GROUP1, 5,1, 0 } ;
const pin RB4  = { &RB, 16,    &RPB4R,  &GROUP1, 0, 0 } ;
const pin RB5  = { &RB, 32,    &RPB5R,  &GROUP2, 0, 1 } ;
const pin RB6  = { &RB, 64,    &RPB6R,  &GROUP3, 0, 1 } ;
const pin RB7  = { &RB, 128,   &RPB7R,  &GROUP1, 0, 1 } ;
const pin RB8  = { &RB, 256,   &RPB8R,  &GROUP2, 0, 1 } ;
const pin RB9  = { &RB, 512,   &RPB9R,  &GROUP4, 0, 1 } ;
const pin RB10 = { &RB, 1024,  &RPB10R, &GROUP4, 0, 1 } ;
const pin RB11 = { &RB, 2048,  &RPB11R, &GROUP2, 0, 1 } ;
const pin RB12 = { &RB, 4096,  &RPB12R, NULL   , 1, 0 } ;
const pin RB13 = { &RB, 8192,  &RPB13R, &GROUP3, 1, 0 } ;
const pin RB14 = { &RB, 16384, &RPB14R, &GROUP4, 0, 0 } ;
const pin RB15 = { &RB, 32768, &RPB15R, &GROUP1, 9, 1, 0 } ;
